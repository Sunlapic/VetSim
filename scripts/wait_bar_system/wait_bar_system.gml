...
/// @function wait_bar_cap_ring(_cx, _cy, _r1, _r2, _a1, _a2)
/// @description ЗАЛИТОЕ полукольцо между радиусами _r1 и _r2 из
///              маленьких ЗАЛИТЫХ КРУГОВ, расставленных по среднему
///              радиусу. ПАКЕТ №339: треугольники draw_primitive у
///              пользователя вообще не нарисовались (остались две
///              полоски), draw_line распадается на тонкие линии —
///              а залитый draw_circle есть в любой версии и
///              масштабируется вместе с координатами.
function wait_bar_cap_ring(_cx, _cy, _r1, _r2, _a1, _a2) {

    var _rm = (_r1 + _r2) * 0.5;
    var _dot = (_r2 - _r1) * 0.5 + 0.45;
    var _steps = 14;
    ...
    for (var _i = 0; _i <= _steps; _i++) {
        ...
        draw_circle(
            _cx + lengthdir_x(_rm, _a),
            _cy + lengthdir_y(_rm, _a),
            _dot, false
        );
    }
...
function wait_bar_capsule_band(_x1, _y1, _x2, _y2, _o1, _o2) {
    ...
    if (_rx <= _lx) {
        ...
        wait_bar_cap_ring(_lx, _cy, _r + _o1 - 1, _r + _o2, 90, 270);
        wait_bar_cap_ring(_rx, _cy, _r + _o1 - 1, _r + _o2, 270, 450);
        return true;
    }
