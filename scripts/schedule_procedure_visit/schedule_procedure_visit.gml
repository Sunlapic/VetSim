function schedule_procedure_visit(_owner_id, _pet_id, _case, _days_delay, _reason) {
    ...
    for (var i = 0; i < array_length(global.scheduled_visits); i++) {
        ...
        && _sv.pet_id == _pet_id
        && _sv.visit_type_id == "procedure_visit") {
    ...
    var _prescribed_treatment_ids = variable_struct_exists(_case, "prescribed_treatment_ids") ? _case.prescribed_treatment_ids : [];
    var _pending_procedure_actions = case_build_next_procedure_assignments(_case);
    ...
    var _scheduled = {
        ...
        start_condition : clamp(_case.condition, 0, 100),
        ...
        prescribed_treatment_ids : _prescribed_treatment_ids,
        pending_procedure_actions : _pending_procedure_actions,

        case_status : variable_struct_exists(_case, "case_status") ? _case.case_status : "procedure_waiting"
    };
