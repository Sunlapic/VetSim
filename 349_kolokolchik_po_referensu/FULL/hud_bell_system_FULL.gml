...
function hud_draw_bell_icon(_cx, _cy, _r, _ink, _paper) {
    ...
    // ── Тело: почти ровные бока, плавный развал книзу.
    // Полосы сверху вниз; ширина каждой — по нижней границе,
    // чтобы силуэт шёл без дырок.
    var _ys = [
        -0.52, -0.40, -0.28, -0.16, -0.04,
        0.08, 0.18, 0.27, 0.35, 0.42, 0.48, 0.53, 0.57
    ];
    var _hws = [
        0.55, 0.57, 0.585, 0.595, 0.605,
        0.62, 0.645, 0.68, 0.73, 0.79, 0.86, 0.92, 0.97
    ];

    for (var _i = 0; _i < array_length(_ys) - 1; _i++) {
        var _hw = _hws[_i + 1] * _r;
        draw_rectangle(
            _cx - _hw, _cy + _ys[_i] * _r,
            _cx + _hw, _cy + _ys[_i + 1] * _r + 1, false
        );
    }
