...
// ── Пакет 347: колокольчик и панель просьб — самый верхний слой,
// чтобы модальная панель легла поверх всех окон.
if (script_exists(asset_get_index("hud_draw_bell_button"))) {
    hud_draw_bell_button(id);
}
