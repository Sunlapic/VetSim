...
function tree_sections() {
    ...
    // ── СТАЦИОНАР: палата плюс койки сверх двух ──
    ...
    if (_bed_limit > 0) {
        ...
        for (var _bed = 103; _bed < 101 + _bed_limit; _bed++) {
...
function tree_node_state(_node) {
    switch (_node.kind) {
        ...
        case "bed": {
            ...
            if (round(_node.key) >= 104 && !clinic_bed_is_open(round(_node.key) - 1)) {
                return "lock";
            }
            return "open";
        }
