...
wander_x2 = 2000;
wander_y2 = 1200;
wander_idle_timer = game_get_speed(gamespeed_fps) * 2;
...
reception_timer = 0;
reception_duration = game_get_speed(gamespeed_fps) * 4;
...
register_duration = game_get_speed(gamespeed_fps) * 10;
payment_duration = game_get_speed(gamespeed_fps) * 10;
