...
function tablet_staff_skill_stats_line(_help_id, _target) {
    ...
    switch (_id) {
        case "therapy":
            ...
            _speed_text = string(
                round(doctor_get_exam_duration_frames(_level) / game_get_speed(gamespeed_fps) * 10) / 10
            ) + "С";
            break;
        ...
        case "cleaning":
            _speed_text = string(
                round(cleaning_get_duration_frames(_level) / game_get_speed(gamespeed_fps) * 10) / 10
            ) + "С";
            break;
